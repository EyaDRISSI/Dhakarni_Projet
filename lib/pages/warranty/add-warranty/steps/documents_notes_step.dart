...
class DocumentsNotesStep extends StatelessWidget {
  ...
  final Function(FileType, List<String>?, Function(File?)) pickFile;
        ...
        children: [
          ...
          Container(
            ...
            child: invoiceFile == null
                ? ElevatedButton.icon(
                    onPressed: () => pickFile(
                        FileType.custom, ['jpg', 'jpeg', 'png', 'pdf'], onPickInvoice),
          ...
          Container(
            ...
            child: certificateFile == null
                ? ElevatedButton.icon(
                    onPressed: () => pickFile(
                        FileType.custom, ['jpg', 'jpeg', 'png', 'pdf'], onPickCertificate),
                    icon: const Icon(Icons.cloud_upload_outlined,
